# <b>ᏒΞᎠFOX</b>
![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=welcome+To+mallu+movie!;created+by+𝐀𝐚𝐝𝐡𝐢!;A+simple+autofilter+Bot!;Auto+filter+with+double+button!;start+message+with+pic!;and+all+other+features!)
